...
import numpy as np
import data_read2 as reader
import ml_dec_tree2 as DT
import ml_svm2 as SVM
import xlsxwriter
import time
import copy
...
def decisionTree(filter_input_train,filter_output_train,filter_errors_train,input_test,output_test):
    ...
    features = {
        ...
        'sky':DT.calculateStatistics(filter_input_train,'sky')
        }
    ...
    worksheet.write(17,0,'sky')
    avg_sky = features['sky'][0]
    std_dev_sky = features['sky'][1]
    worksheet.write(17,1,avg_sky)
    worksheet.write(17,2,std_dev_sky)
    worksheet.write(17,3,str(DT.createGroupsContinuous(possible_segmentation,avg_sky,std_dev_sky)))
...
def svr(filter_input_train_svr,filter_output_train_svr,filter_errors_train_svr,input_test_svr,output_test_svr):
    ...
    all_features_include = ['difference_ENU','nr_used_measurements','cno','elevation','innovation_ENU','sky','constellation','azimuth','ndop','lsq_residual','pdop']
    ...
    "Opens Workbook:"
    workbook = xlsxwriter.Workbook('little_test.xlsx')
                ...
                for g in gamma_i:
                    ...
                    for c in C_i:
                        ...
                        for d in degree:
                            ...
                            # Iterate to find the best combination of features to be used for the SVM
...
possible_input = ['gardet2']
possible_output = ['expecGardet2']
