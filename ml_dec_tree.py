...
def gain(dataset,feature_string,tree,segmentation,filter_errors,histo_original,divisions,features):
    ...
    if feature_string == 'cno' or feature_string == 'lsq_residual' or feature_string == 'elevation' or feature_string == 'azimuth' or feature_string == 'pdop' or feature_string == 'ndop':
...
def selectByFeature(input_dataset,feature_string,segmentation,features):
    ...
    if feature_string == 'cno' or feature_string == 'lsq_residual' or feature_string == 'elevation' or feature_string == 'azimuth' or feature_string == 'pdop' or feature_string == 'ndop' or sub_string == 'prediction_state' or sub_string == 'prediction_covariance' or sub_string == 'correction_state' or sub_string == 'correction_covariance' or sub_string =='difference_ENU' or sub_string == 'innovation_ENU':
...
def testTree(input_test,output_test,divisor_bins,segmentation,tree_classifier_train,nodes_labels_train,divisions,average_per_bin,features,tree_depth):
    ...
    def splitNodeByFeature(dataset,segmentation,features,tree_classifier):
        ...
        for i in nodes:
            ...
            elif feature == 'pdop' or feature == 'ndop':
